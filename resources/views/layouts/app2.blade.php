...
{{-- Tempat untuk CSS tambahan dari child views --}}
    @stack('styles') {{-- Tambahkan baris ini untuk CSS --}}
  </head>
  <!--end::Head-->
...
<div class="user-panel d-flex align-items-center p-3">
  <div class="flex-shrink-0">
    <img src="{{ asset('/lte/dist/assets/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image" style="width: 40px; height: 40px;">
  </div>
  <div class="flex-grow-1 ms-2">
    <a href="#" class="d-block text-white text-decoration-none fw-light">{{ Auth::user()->email ?? 'Guest' }}</a>
  </div>
</div>
...
<footer class="app-footer">
        ...
        <strong>
          Copyright &copy; 2025&nbsp;
          <a href="https://adminlte.io" class="text-decoration-none">Wildan</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
    ...
    <script>
      ...
      {{-- Tempat untuk JavaScript tambahan dari child views --}}
    @stack('scripts') {{-- Tambahkan baris ini untuk JavaScript --}}
