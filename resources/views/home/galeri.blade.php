    ...
    <!-- navbar end -->
        ...
        <!-- Galeri/porto -->
    <div class="my-5 py-5 pt-5 bg-dark text-white text-center">
    <h1 class="fw-bolder"> Galeri</h1>
    <p class="">Hasil Semua Pekerjaan Kami</p>
    </div>
        <!-- Galeri/porto end -->
...
<div class="container py-5">
  <div class="row justify-content-center g-4 px-3"> <!-- g-4 atur spacing antar kolom & baris -->
    
    <div class="col-12 col-sm-6 col-lg-4">
      <div class="card border-0 h-100">
        <img src="img/1.jpg" class="img-fluid w-100" alt="Gambar 1">
      </div>
    </div>

    <div class="col-12 col-sm-6 col-lg-4">
      <div class="card border-0 h-100">
        <img src="img/1.jpg" class="img-fluid w-100" alt="Gambar 2">
      </div>
    </div>

    <div class="col-12 col-sm-6 col-lg-4">
      <div class="card border-0 h-100">
        <img src="img/1.jpg" class="img-fluid w-100" alt="Gambar 3">
      </div>
    </div>

    <div class="col-12 col-sm-6 col-lg-4">
      <div class="card border-0 h-100">
        <img src="img/1.jpg" class="img-fluid w-100" alt="Gambar 4">
      </div>
    </div>

    <div class="col-12 col-sm-6 col-lg-4">
      <div class="card border-0 h-100">
        <img src="img/1.jpg" class="img-fluid w-100" alt="Gambar 5">
      </div>
    </div>

    <div class="col-12 col-sm-6 col-lg-4">
      <div class="card border-0 h-100">
        <img src="img/1.jpg" class="img-fluid w-100" alt="Gambar 6">
      </div>
    </div>
